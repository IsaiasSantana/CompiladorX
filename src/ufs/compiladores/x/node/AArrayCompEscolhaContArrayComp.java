...
public final class AArrayCompEscolhaContArrayComp extends PContArrayComp
{
    private PArrayComp _arrayComp_;

    public AArrayCompEscolhaContArrayComp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArrayCompEscolhaContArrayComp(
    ...
    {
        ((Analysis) sw).caseAArrayCompEscolhaContArrayComp(this);
    }
