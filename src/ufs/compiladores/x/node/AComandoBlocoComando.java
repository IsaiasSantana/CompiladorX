...
public final class AComandoBlocoComando extends PComando
{
    private PBloco _bloco_;

    public AComandoBlocoComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoBlocoComando(
    ...
    {
        ((Analysis) sw).caseAComandoBlocoComando(this);
    }
