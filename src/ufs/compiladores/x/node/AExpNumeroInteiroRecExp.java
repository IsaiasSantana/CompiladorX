...
public final class AExpNumeroInteiroRecExp extends PRecExp
{
    private TNumeroInteiro _numeroInteiro_;

    public AExpNumeroInteiroRecExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpNumeroInteiroRecExp(
    ...
    {
        ((Analysis) sw).caseAExpNumeroInteiroRecExp(this);
    }
