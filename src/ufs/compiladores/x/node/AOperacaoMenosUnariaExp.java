...
public final class AOperacaoMenosUnariaExp extends PExp
{
    private TMenos _menos_;
    private PExp _exp_;

    public AOperacaoMenosUnariaExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOperacaoMenosUnariaExp(
    ...
    {
        ((Analysis) sw).caseAOperacaoMenosUnariaExp(this);
    }
