...
public final class ADecConstanteUnicoPrograma extends PPrograma
{
    private PDecConst _decConst_;

    public ADecConstanteUnicoPrograma()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecConstanteUnicoPrograma(
    ...
    {
        ((Analysis) sw).caseADecConstanteUnicoPrograma(this);
    }
