...
public final class ADecVariavelUnicoPrograma extends PPrograma
{
    private PDecVar _decVar_;

    public ADecVariavelUnicoPrograma()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecVariavelUnicoPrograma(
    ...
    {
        ((Analysis) sw).caseADecVariavelUnicoPrograma(this);
    }
