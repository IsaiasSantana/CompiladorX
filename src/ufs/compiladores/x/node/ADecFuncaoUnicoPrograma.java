...
public final class ADecFuncaoUnicoPrograma extends PPrograma
{
    private PDecFuncao _decFuncao_;

    public ADecFuncaoUnicoPrograma()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecFuncaoUnicoPrograma(
    ...
    {
        ((Analysis) sw).caseADecFuncaoUnicoPrograma(this);
    }
