...
public final class AOperacaoSubtracaoExp extends PExp
{
    private PExp _left_;
    private PExp _right_;

    public AOperacaoSubtracaoExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOperacaoSubtracaoExp(
    ...
    {
        ((Analysis) sw).caseAOperacaoSubtracaoExp(this);
    }
