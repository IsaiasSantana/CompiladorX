...
public final class AOpDecConstOpcaoBloco extends POpcaoBloco
{
    private PDecConst _decConst_;

    public AOpDecConstOpcaoBloco()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOpDecConstOpcaoBloco(
    ...
    {
        ((Analysis) sw).caseAOpDecConstOpcaoBloco(this);
    }
