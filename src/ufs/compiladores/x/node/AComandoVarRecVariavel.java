...
public final class AComandoVarRecVariavel extends PVariavel
{
    private PVariavel _variavel_;
    private PExp _exp_;

    public AComandoVarRecVariavel()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoVarRecVariavel(
    ...
    {
        ((Analysis) sw).caseAComandoVarRecVariavel(this);
    }
