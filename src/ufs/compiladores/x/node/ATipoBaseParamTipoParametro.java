...
public final class ATipoBaseParamTipoParametro extends PTipoParametro
{
    private PTipoBase _tipoBase_;

    public ATipoBaseParamTipoParametro()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATipoBaseParamTipoParametro(
    ...
    {
        ((Analysis) sw).caseATipoBaseParamTipoParametro(this);
    }
