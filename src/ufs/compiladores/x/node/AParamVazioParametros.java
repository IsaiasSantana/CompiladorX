...
public final class AParamVazioParametros extends PParametros
{
    private PVazio _vazio_;

    public AParamVazioParametros()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParamVazioParametros(
    ...
    {
        ((Analysis) sw).caseAParamVazioParametros(this);
    }
