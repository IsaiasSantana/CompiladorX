...
public final class AOperacaoMultiplicacaoExp extends PExp
{
    private PExp _left_;
    private PExp _right_;

    public AOperacaoMultiplicacaoExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOperacaoMultiplicacaoExp(
    ...
    {
        ((Analysis) sw).caseAOperacaoMultiplicacaoExp(this);
    }
