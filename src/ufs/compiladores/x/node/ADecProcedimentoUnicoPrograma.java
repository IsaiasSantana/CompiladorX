...
public final class ADecProcedimentoUnicoPrograma extends PPrograma
{
    private PDecProcedimento _decProcedimento_;

    public ADecProcedimentoUnicoPrograma()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecProcedimentoUnicoPrograma(
    ...
    {
        ((Analysis) sw).caseADecProcedimentoUnicoPrograma(this);
    }
