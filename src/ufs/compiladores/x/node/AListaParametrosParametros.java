...
public final class AListaParametrosParametros extends PParametros
{
    private PParametro _parametro_;
    private PParametroCont _parametroCont_;

    public AListaParametrosParametros()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListaParametrosParametros(
    ...
    {
        ((Analysis) sw).caseAListaParametrosParametros(this);
    }
