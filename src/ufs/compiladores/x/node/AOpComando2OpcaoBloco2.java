...
public final class AOpComando2OpcaoBloco2 extends POpcaoBloco2
{
    private PComando2 _comando2_;

    public AOpComando2OpcaoBloco2()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOpComando2OpcaoBloco2(
    ...
    {
        ((Analysis) sw).caseAOpComando2OpcaoBloco2(this);
    }
